...
namespace UCR.ECCI.PI.ThemePark.Backend.Application.Roles.Services;
...
public interface IRoleService
{
    ...
    /// <returns>
    /// A task that represents the asynchronous operation. The task result containsa tuple with the
    ...
    /// </summary>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains a list of all <see cref="Role"/> entities.
    /// </returns>
    ...
    /// </returns>
    public Task<(IEnumerable<Permission>? permissions, string? errorMessage)> GetRolePermissionsAsync(int roleId);
