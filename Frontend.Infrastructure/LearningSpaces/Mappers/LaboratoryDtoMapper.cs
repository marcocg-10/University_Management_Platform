...
internal static class LaboratoryDtoMapper
{
    public static Laboratory ToEntity(this LaboratoryDto dto)
    {
        ...
        var colorValue = dto.Color ?? throw new ArgumentNullException(nameof(dto.Color), "Laboratory.Color is null");
        var textureValue = dto.Texture ?? throw new ArgumentNullException(nameof(dto.Texture), "Laboratory.Texture is null");
