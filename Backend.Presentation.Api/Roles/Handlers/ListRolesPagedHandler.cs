...
internal class ListRolesPagedHandler
{
    /// <summary>
    ...
    /// 100.</exception>
    public static async Task<ListRolesPagedResponse> HandleAsync(
        ...
        [FromQuery] int pageSize)
    {
        ...
        var (roles, totalCount) = await roleService
            .ListRolesPagedAsync(pageNumber, pageSize);
        ...
        return new ListRolesPagedResponse(roleDtos, paginationMetadata);
    }
}