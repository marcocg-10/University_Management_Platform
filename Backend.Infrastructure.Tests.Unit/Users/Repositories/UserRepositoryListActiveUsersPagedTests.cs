...
/// the database.
/// </summary>
public class UserRepositoryListActiveUsersPagedTests
{
    ...
    public UserRepositoryListActiveUsersPagedTests()
    {
    ...
    public async Task ListBoardsPagedAsync_Should_Return_Correct_Page()
    {
        ...
        // Act
        var (pagedUsers, totalCount) = await _repository.ListActiveUsersPagedAsync(2, 10);
    ...
    public async Task ListBoardsPagedAsync_Should_Return_First_Page_Correctly()
    {
        ...
        // Act
        var (pagedUsers, totalCount) = await _repository.ListActiveUsersPagedAsync(1, 10);
    ...
    public async Task ListBoardsPagedAsync_Should_Return_Last_Page_With_Remaining_Items()
    {
        ...
        // Act
        var (pagedUsers, totalCount) = await _repository.ListActiveUsersPagedAsync(3, 10);
    ...
    public async Task ListBoardsPagedAsync_Should_Return_Empty_When_Page_Exceeds_Total()
    {
        ...
        // Act
        var (pagedUsers, totalCount) = await _repository.ListActiveUsersPagedAsync(5, 10);
    ...
    {
        // Act
        Func<Task> act = () => _repository.ListActiveUsersPagedAsync(invalidPageNumber, 10);
    ...
    {
        // Act
        Func<Task> act = () => _repository.ListActiveUsersPagedAsync(1, invalidPageSize);
