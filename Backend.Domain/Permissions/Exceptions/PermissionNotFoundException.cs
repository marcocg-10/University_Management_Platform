...
public class PermissionNotFoundException : PermissionException
{

    /// <summary>
    /// Initializes a new instance of the <see cref="PermissionNotFoundException"/> class with a specified error message.
    /// </summary>
    /// <param name="message">The message that describes the error.</param>
    /// </summary>
    /// <param name="message"></param>
    public PermissionNotFoundException(PermissionName name)
    ...
    /// specified.</param>
    public PermissionNotFoundException(PermissionName name, Exception innerException)
