...
/// A Projector is a specific type of InteractiveComponent with its type set accordingly.
/// </summary>
public class Projector : InteractiveComponent
{
    ...
    /// <param name="rotations">The current rotation of the Projector.</param>
    ...
    )
    {
        ...
        InteractiveComponentType = InteractiveComponentType.Projector;
    }
}
