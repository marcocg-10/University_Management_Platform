...
namespace UCR.ECCI.PI.ThemePark.Frontend.Tests.Unit.Users.ValueObjects;
...
public class UserIdTests
{
    ...
    public void TryCreate_GivenInvalidUserId_ReturnsFalse(string inputId)
    {
        ...
        idError.Should().Be(
            "Id must be between 5 and 30 characters (letters, numbers, hyphens) and must not start or end with a hyphen",
    ...
    public void Create_GivenInvalidId_ThrowsValidationException(string inputId)
    {
        ...
        FluentActions.Invoking(() =>
            ...
            .ThrowExactly<UserDataException>(because: "the Id has an invalid format")
            .WithMessage("Id must be between 5 and 30 characters (letters, numbers, hyphens) and must not start or end with a hyphen");
    }
    ...
    public void EqualityOperator_GivenTwoDifferentUserIds_AreUnequal(string inputId1, string inputId2)
    {
        ...
        // Assert
        id1.Should().NotBe(id2, because: "both user ids have the same value");
    }
