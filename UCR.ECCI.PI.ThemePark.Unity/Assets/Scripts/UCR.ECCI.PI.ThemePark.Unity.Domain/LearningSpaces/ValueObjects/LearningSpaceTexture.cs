...
using UCR.ECCI.PI.ThemePark.Unity.Domain.LearningSpaces.Exceptions;
using UCR.ECCI.PI.ThemePark.Unity.Domain.Core.ValueObjects;
using UCR.ECCI.PI.ThemePark.Unity.Domain.LearningSpaces.Exceptions;
using UnityEngine;

namespace UCR.ECCI.PI.ThemePark.Unity.Domain.LearningSpaces.ValueObjects {
    public class LearningSpaceTexture : ValueObject
    {
        ...
        public static LearningSpaceTexture Create(string input)
        {
            ...
            {
                throw new LearningSpaceDataException(string.Format("Texture {0} is invalid, it must be less than or " +
